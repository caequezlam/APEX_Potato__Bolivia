...
luk="D:/APEX_1501_TORA/11_PAPER_APEX_IRRIGATION/Irrigation_APEX/LUKI_PAPER/0ut_PAPER_LUKI.SAD"
...
"OBSERVED Luki"
Obsluk1=np.array([ Observed[jj][3] for jj in range(0,198)])
...
def plot(a):
    ...
    plt.ylabel('Simulado [g/m2]',**font_1,color='black')
    plt.xlabel("Observado [g/m2]",**font_1,color='black')
...
plt.plot_date(timegrowth, LUKI, 'o-',markersize=6,color='g',markeredgecolor='darkgreen',linewidth=2,
...
plt.ylabel('LUKI biomass [g/m2]',**font,color='k')
plt.xlabel("Month",**font,color='k')
plt.yticks(boundsY, boundsY,fontsize=15,color='k')
plt.annotate("PBIAS= "+ str(PBIAS_LUKI),(729708,500),**font,color='darkgreen',size=20)
plt.annotate("NSE= "+ str(NSE_LUKI),(729708,600),**font,color='darkgreen',size=20)
plt.annotate("R2= "+ str(R2luk),(729708,400),**font,color='darkgreen',size=20)
plt.xticks(fontsize=15,color='k')
plt.title("Validation PUCHUNI - LUKI Biomass growth",fontsize=20,fontstyle="italic",color='k')
